...
st.set_page_config(page_title="HidroSed SedGran v3.7.3 Correctivas Plus", page_icon="🌊", layout="wide")
...
st.sidebar.title("HidroSed SedGran v3.7.3")
        ...
        if st.button("Calcular perfil hidráulico conectado tipo HEC-RAS", type="primary"):
            try:
                ...
                if n_fallback > 0:
                    ...
                    st.success("Perfil hidráulico conectado calculado con secciones reales + normativa.")
            except Exception as exc:
                st.error(str(exc))
